        ...
        String[] SelectionTypes = {"Doctor","Patient", "Employee","Admin","exit"};
...

            {
                ...
                if (SelectionType.equals("Doctor"))
                {
                    ...
                    String[] SelectionTypesDoc= {"Doctor","Patient","Medicines","Laboratories","Employee"};
                    while (s1) {
                ...
                else if(SelectionType.equals("Employee"))
                {
                    ...
                    while (s6) {
                        JOptionPane.showMessageDialog(null, "Login successful!");
                        String[] Selection = {"Patient", "Nurse", "Worker", "Security","Medicines", "Laboratories", "Facilities"};
                    ...
                    if (log) {
                        JOptionPane.showMessageDialog(null, "Login successful!");
                        String[] SelectionTypesAdmin = {"Doctor", "Patient", "Medicines", "Laboratories", "Facilities", "Employee", "Admin Info and Change Option", "exit"};
                        while (status1) {
